(function() {
	...
	function setTimeoutForRequest(requestId, requestTimeout = 10000) {
	...
	function sendRequest(request) {
		...
		if(window.opener){
			window.opener.postMessage(message, __origin);
		}else{
	...
	var Client = function(data) {
		...
		this.globalData = {
			...
			},get: function(dataObject, updateData) {
				return new Promise(function(resolve, reject) {
					var requestId = getUniqueID();
					var request = {
						"requestId": requestId,
			...
			transfer: function(dataObject, updateData) {
				return new Promise(function(resolve, reject) {
					var requestId = getUniqueID();
					var request = {
						"requestId": requestId,
			...
			bulkUpdate: function(dataObject, ids, updateData) {
				return new Promise(function(resolve, reject) {
					var requestId = getUniqueID();
					var request = {
						"requestId": requestId,
			...
			bulkAction: function(dataObject, actionType, ids, actionData) {
				return new Promise(function(resolve, reject) {
					var requestId = getUniqueID();
					var request = {
						"requestId": requestId,
			...
			getTickets: function(dataObject, filterData) {
				return new Promise(function(resolve, reject) {
					var requestId = getUniqueID();
					var request = {
						"requestId": requestId,
					...
					setRequestCallback(requestId, resolve, reject);
					sendRequest(request);
					setTimeoutForRequest(requestId, 20000);
				});
			},
			addNote: function(dataObject, addNoteData) {
			return new Promise(function(resolve, reject) {
			var requestId = getUniqueID();
			var request = {
			"requestId": requestId,
			...
			takeSnap: function(dataObject, snapData, isLocal = false) {
				return new Promise(function(resolve, reject) {
				var requestId = getUniqueID();
				var request = {
				"requestId": requestId,
			...
			invoke: function(dataObject, snapData) {
				return new Promise(function(resolve, reject) {
				var requestId = getUniqueID();
				var request = {
				"requestId": requestId,
		...
		this.contextData = {
			...
			view: function(dataObject, viewData) {
			return new Promise(function(resolve, reject) {
			var requestId = getUniqueID();
			var request = {
			"requestId": requestId,
			...
			refresh: function(dataObject, refreshData) {
				return new Promise(function(resolve, reject) {
				var requestId = getUniqueID();
				var request = {
				"requestId": requestId,
			...
			attachCall: function(dataObject, attachCallData) {
				return new Promise(function(resolve, reject) {
				var requestId = getUniqueID();
				var request = {
				"requestId": requestId,
			...
			unattachCall: function(dataObject, unattachCallData) {
				return new Promise(function(resolve, reject) {
				var requestId = getUniqueID();
				var request = {
				"requestId": requestId,
				...
				"requestData": {
				"dataObject": dataObject,
				"unattachCallData": unattachCallData
				}
				};
				setRequestCallback(requestId, resolve, reject);
				sendRequest(request);
			...
			merge: function(dataObject, mergeData) {
				return new Promise(function(resolve, reject) {
				var requestId = getUniqueID();
				var request = {
				"requestId": requestId,
			...
			split: function(dataObject, splitData) {
				return new Promise(function(resolve, reject) {
				var requestId = getUniqueID();
				var request = {
				"requestId": requestId,
			...
			unassign: function(dataObject, unassignData) {
				return new Promise(function(resolve, reject) {
				var requestId = getUniqueID();
				var request = {
				"requestId": requestId,
			...
			reassign: function(dataObject, reassignData) {
				return new Promise(function(resolve, reject) {
				var requestId = getUniqueID();
				var request = {
				"requestId": requestId,
			...
			pick: function(dataObject, pickData) {
				return new Promise(function(resolve, reject) {
				var requestId = getUniqueID();
				var request = {
				"requestId": requestId,
			...
			getSkillData: function(dataObject, queueId) {
				return new Promise(function(resolve, reject) {
					var requestId = getUniqueID();
					var request = {
						"requestId": requestId,
		...
		this.interface = {
			...
			open: function(contextName, contextData) {
				return new Promise(function(resolve, reject) {
					var requestId = getUniqueID();
					var request = {
						"requestId": requestId,
		...
		this.contextEvent = {
				register: function(eventName, eventCallback) {
					return new Promise(function(resolve, reject) {
						...
						var request = {
							"requestId": requestId,
							"service": "contextEvent",
							"method": "register",
							"requestData": {
								"eventName": eventName
							}
						};
						var event = "contextEvent:" + eventName;
						setEventCallback(event, eventCallback);
						setRequestCallback(requestId, resolve, reject);
						sendRequest(request);
						setTimeoutForRequest(requestId);
		...
		this.augmentModel = {
			add: function(dataObject, augmentData) {
				return new Promise(function(resolve, reject) {
					var requestId = getUniqueID();
					var request = {
						"requestId": requestId,
						"service": "augmentModel",
						"method": "add",
						"requestData": {
							"dataObject": dataObject,
		...
		this.request = {
			api: function(requestName, requestParams, pathParam) {
				return new Promise(function(resolve, reject) {
					var requestId = getUniqueID();
					var request = {
						"requestId": requestId,
...
/*
 * ! Native Promise Only v0.8.1 (c) Kyle Simpson MIT License:
